  ...
  >
    ...
    >
      <transition name="arrow-slide">
        <i :class="['ac-icon-triangle', { 'hovering': hovering }, isExpanded && 'down']"></i>
      </transition>
      <transition name="text-slide">
        <span v-show="hovering">{{ controlText }}</span>
      </transition>
      <div class="control-button-container">
        <span class="control-button copy-button" @click.stop="copy">{{ langConfig['copy-button-text'] }}</span>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    isExpanded(val) {
      ...
      setTimeout(() => {
        this.scrollParent = document.querySelector('.page-component__scroll > .ac-scrollbar__wrap')
